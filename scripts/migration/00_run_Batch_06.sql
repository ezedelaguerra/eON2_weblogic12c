...
@Batch_06\Batch_06_Company.sql
@Batch_06\Batch_06_CompanyDealingPattern.sql
@Batch_06\Batch_06_UserDealingPattern.sql
@Batch_06\Batch_06_Users.sql
COMMIT;

-------- stored procedures -----------
@Batch_06\proc_populate_sku.sql
@Batch_06\proc_populate_order_item.sql
@Batch_06\proc_populate_order_item_visibility.sql
