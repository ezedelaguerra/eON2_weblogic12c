Class('App.hideColumnMaintenance', 'linb.Com',{
    ...
    Instance:{    
        iniComponents:function(){
            ...
            // next column
            host.grpColumn.append((new linb.UI.CheckBox)
                .host(host,"skuMaxLimit")
                .setDirtyMark(false)
                .setLeft(380)
                .setTop(10)
                .setWidth(145)
                .setCaption("$app.caption.skumaxlimit")
            );
        ...
        _btnSave_onclick:function (profile, e, src, value) {
        	...
        	param.price1 = this.price1.getUIValue() == true ? "1" : "0";
        	param.price2 = this.price2.getUIValue() == true ? "1" : "0";
        	...
        	param.skuMaxLimit = this.skuMaxLimit.getUIValue() == true ? "1" : "0";
        ...
        renderColumns : function (hc) {
        	...
        	this.price1.setUIValue(hc.price1 == "1" ? true : false);
        	this.price2.setUIValue(hc.price2 == "1" ? true : false);
        	...
        	this.skuMaxLimit.setUIValue(hc.skuMaxLimit == "1" ? true : false);
