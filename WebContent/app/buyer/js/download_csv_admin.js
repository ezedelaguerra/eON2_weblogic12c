...
Class('App.downloadcsv', 'linb.Com',{
    Instance:{
        ...
        loadSellerList: function () {
            downloadcsv.lstSellers.clearItems();
            if(downloadcsv.getBuyerList() == "") return true;
            ...
            obj.selectedBuyerIds = downloadcsv.getBuyerList();
            linb.Ajax(url,obj,
                function(response){
            		validateResponse(response);
                    var obj = _.unserialize(response);
