...
Class('App.hideColumnMaintenance', 'linb.Com',{
    ...
    Instance:{    
        ...
        _onrender:function(page, threadid){
            ...
            if (is_chrome) {
            	hideColMaint.hideColMaintenance.setWidth(830);
            	hideColMaint.grpColumn.setWidth(800);
            	hideColMaint.grpColumn.setHeight(440);
            }
            // ENHANCEMENT END 20120913: Lele - Redmine 880
